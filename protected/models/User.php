...
class User extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('USR_GROUP, USR_NAZWA, USR_HASLO, USR_FIRSTNAME, USR_LASTNAME, USR_EMAIL', 'required'),
	...
	{
		return round(($this->USR_COOPER_COUNT > 0 ? $this->USR_COOPER / $this->USR_COOPER_COUNT : 0),6);
	}
	
	public function Assertivity()
	{
		return round(($this->USR_ASSERT_COUNT > 0 ? $this->USR_ASSERT / $this->USR_ASSERT_COUNT : 0),6);
	}
	...
	public function attributeLabels()
	{
		return array(
			...
			'USR_ASSERT' => 'Assertivness',
			'USR_COOPER' => 'Cooperativness',
			'USR_ASSERT_COUNT' => 'Assertivness Count',
			'USR_COOPER_COUNT' => 'Cooperativness Count',
			'USR_GROUP' => 'Group',
			'USR_WHOLENAME' => 'Name',
		);
	}
